...
import render_quote_and_reply_popover from "../templates/popovers/quote_and_reply_popover.hbs";
...
function show_quote_and_reply_popover(message_id, selected_message_content_raw, selection_bounds) {
    ...
    popover_menus.toggle_popover_menu(reference_element, {
        ...
        onShow(instance) {
            ...
            instance.setContent(parse_html(render_quote_and_reply_popover()));
            return true;
        },
        onHidden(instance) {
            instance.destroy();
        ...
        onMount(instance) {
            ...
            $popper.on("click", ".quote_and_reply", (e) => {
                quote_and_reply({
                    message_id,
...
function suggest_quoting_message_selection(selection = window.getSelection()) {
    ...
    if (selected_message_content_raw) {
        const message_id = start_id;
        show_quote_and_reply_popover(message_id, selected_message_content_raw, selection_bounds);
    }
}
...
export function initialize() {
    ...
    $("body").on("mouseup", ".messagebox", () => {
        // This gives the browser time to update the value returned by window.getSelection().
        // This is necessary to avoid showing the popover for the selection before, that this
        // click clears.
        setTimeout(() => {
